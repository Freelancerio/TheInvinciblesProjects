...
const TeamStatisticsPage = () => {
  ...
  const API_BASE_URL = 'https://localhost:8080/api/database/psl';
          ...
          <div style={{
            ...
            <button style={{
              ...
              <div style={{ color: '#141414' }}>
                <svg xmlns="https://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
