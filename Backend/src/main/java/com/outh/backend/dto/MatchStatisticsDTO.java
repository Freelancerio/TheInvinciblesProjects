...
/**
 * DTO representing a single team's match statistics row (home or away).
 * Returned by the match statistics endpoint as a list of two items (home + away).
 */
public class MatchStatisticsDTO {
    ...
    public MatchStatisticsDTO(Long matchId, Long teamId, String teamName, String teamLogo,
    ...
    public Double getGoalsPrevented() {
        return goalsPrevented;
    }
    public void setGoalsPrevented(Double goalsPrevented) {
        this.goalsPrevented = goalsPrevented;
    }
