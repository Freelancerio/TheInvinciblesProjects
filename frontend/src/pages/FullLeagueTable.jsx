        ...
        <div className="min-h-screen text-white" style={{
            ...
            <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
                ...
                <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                    <label htmlFor="season" className="text-secondary font-semibold text-base sm:text-lg">
                        Season:
                    </label>
                    <select
                        id="season"
               ...
               text-white px-3 sm:px-4 py-2 rounded-lg focus:outline-none focus:ring-2
               focus:ring-secondary text-sm sm:text-base"
                    >
