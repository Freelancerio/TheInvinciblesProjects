      ...
      <div className="min-h-screen text-white" style={{
        ...
        <div className="fixture-content py-6 sm:py-8">
          <div className="container mx-auto px-4 sm:px-6">
            <h1 className="page-title text-2xl sm:text-4xl text-secondary mb-6 sm:mb-8 text-center">Fixture Details</h1>

            <div className="fixture-grid grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              <div className="card-bg backdrop-blur-md rounded-[10px] p-4 sm:p-5 border border-[rgba(255,255,255,0.1)] text-white">
                {loading ? (
                    <div className="text-center py-8 sm:py-10">Loading match statistics...</div>
                ) : (
                    <>
                      <h2 className="text-lg sm:text-xl font-bold mb-4">Match Statistics</h2>
                      {stats.length === 0 ? (
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            {stats.map((team) => (
                                <div
                                    key={team.teamId}
                                    className="bg-[rgba(255,255,255,0.05)] p-3 sm:p-4 rounded-lg shadow"
                                >
                                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                                    ...
                                    />
                                    <h3 className="text-base sm:text-lg font-semibold">{team.teamName}</h3>
                                  </div>
